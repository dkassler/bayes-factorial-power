...
sim <- function(N,    # total sample size
                nA,      # the number of levels that each variable can take             
                nB, 
                nC, 
                nD, 
                cauchyScale=5,
                diff=.25,   # difference between mean and max outcome
                nWarmup=1000, # mcmc settings
                nIter=2000,
                nChains=4){             # difference in effectiveness between avg and most effective arms
